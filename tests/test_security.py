...
from app.core.security import hash_password, verify_password, MIN_PASSWORD_LENGTH
...
class PasswordSecurityTests(unittest.TestCase):
    ...
    def test_same_password_gets_different_hashes(self):
        ...
        self.assertTrue(
            verify_password(password, first_hash)
        )
        self.assertTrue(
            verify_password(password, second_hash)
        )
