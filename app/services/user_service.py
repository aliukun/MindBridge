...
from app.models.entities import ROLE_ADMIN, ROLE_USER, UserAccount
...
def create_user(
    ...
    *,
    ...
    normalized_roles = {role.strip() for role in roles if role.strip()}

    unknown_roles = normalized_roles - ALLOWED_ROLES
    ...
    user.roles = sorted(normalized_roles)
...
def ensure_user(
    ...
    *,
    ...
    existing_user = get_user_by_username(database, username)
